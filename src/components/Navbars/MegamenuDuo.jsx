...
const MegamenuDuo = ({ closeMenu }) => {
  ...
  return (
    <div className="mega-modal">
      ...
      <div className="mega-menu-content-duo">
            ...
            <div className="menu-section" key={cat.id}>
              ...
              <ul>
                {cat.subcategories.map((sub) => (
                  ...
                  >
                    <Link to={`/products/${cat.action_url}/${sub.action_url}`} onClick={() => {
                      console.log("Clicked link:", sub.name);
                      closeMenu();
                    }}>{sub.name}</Link>
                  </li>
                  // <Link
