    ...
    return (
        <>
            <div className="success-container">
                ...
                {/* ✅ Title */}
                <h2 className="success-title">Your {page} is confirmed.</h2>
                <p className="success-subtitle">Our team will be reaching out to you soon to assist further.</p>
